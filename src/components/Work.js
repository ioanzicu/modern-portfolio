            ...
            <div>
              <div class="details">
                ...
                <div class="dtl">
                  ...
                  <a
                    href="https://infinite-fortress-48527.herokuapp.com/"
                    className="btn-light"
                  >
                    {" "}
                  ...
                  <a
                    href="https://github.com/ioanzicu/yelp-camp"
                    className="btn-dark"
                  >
            ...
            <div>
              <div class="details">
                ...
                <div class="dtl">
                  ...
                  <a
                    href="https://evening-citadel-63052.herokuapp.com/"
                    className="btn-light"
                  >
                    {" "}
                    <i className="fas fa-eye" /> Project{" "}
                  ...
                  <a
                    href="https://github.com/ioanzicu/node-chat-app"
                    className="btn-dark"
                  >
                    <i className="fab fa-github" /> Github
                  </a>
            ...
            <div>
              <div class="details">
                ...
                <div class="dtl">
                  ...
                  <a
                    href="https://phoneonline.netlify.com/"
                    className="btn-light"
                  >
                    {" "}
                    <i className="fas fa-eye" /> Project{" "}
                  ...
                  <a
                    href="https://github.com/ioanzicu/react-phone-e-commerce"
                    className="btn-dark"
                  >
                    <i className="fab fa-github" /> Github
                  </a>
            ...
            <div>
              <div class="details">
                ...
                <div class="dtl">
                  ...
                  <a
                    href="https://fathomless-beach-60487.herokuapp.com/"
                    className="btn-light"
                  >
                    {" "}
                    <i className="fas fa-eye" /> Project{" "}
                  ...
                  <a
                    href="https://github.com/ioanzicu/redux-cart-app"
                    className="btn-dark"
                  >
                    <i className="fab fa-github" /> Github
                  </a>
            ...
            <div>
              <div class="details">
                ...
                <div class="dtl">
                  ...
                  <a
                    href="https://github.com/ioanzicu/bicycle-shop"
                    className="btn-dark"
                  >
                    <i className="fab fa-github" /> Github
                  </a>
            ...
            <div>
              <div class="details">
                ...
                <div class="dtl">
                  ...
                  <a
                    href="https://codepen.io/ioanzicu/full/yRzMLZ"
                    className="btn-dark"
                  >
                    <i className="fab fa-github" /> Github
                  </a>
